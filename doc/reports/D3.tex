...
\maketitle
\begin{abstract}
We detail the work currently done on MIM, our Question Answering system. We report a Lenient score of 0.364, and detail the improvements made in the system to achieve said score.
\end{abstract}
